...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    public CardAdapter(Context context, List<MusicInfo> musicInfos) {
    ...
    public CardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_card_music, parent, false);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder holder, @SuppressLint("RecyclerView")int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(),"为您播放"+musicInfo.musicName,Toast.LENGTH_SHORT).show();
                // 跳转到音乐详情页面
